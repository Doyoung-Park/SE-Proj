...
const qnaList = [
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'c. 난 시끄럽고 사람많은 곳 좋아!! 스타벅스 같은 곳으로 가자!',type:[2,3]},
    ]
    },
  {
    q: '최신 맥북이 나왔다! 나의 반응은...!?',
    a: [
      ...
      { answer: 'c. 맥북,,? 나 윈도우 써서 관심없어...',type:[4]},
    ]
  },
  {
  ...
  {
    q: '드디어 자취를 시작했다. 아무것도 없는 집.. 이제 인테리어를 시작하려고 한다. 당신은 어떻게 집을 꾸밀 것인가?',
    a: [
